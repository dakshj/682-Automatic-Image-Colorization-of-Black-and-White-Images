...
from data.image_data import load_raw_image_data, \
    ...
    reconstruct_image_data_from_channels_and_save_images_to_disk, generate_augmented_image_data
...
def train(train_dir, log_dir, epochs, batch_size=32):
    ...
    model.fit_generator(
        generator=generate_augmented_image_data(X_train=X_train, batch_size=batch_size),
...
if __name__ == '__main__':
    ...
    model = train(train_dir=train_dir, log_dir=log_dir, epochs=1500, batch_size=100)
